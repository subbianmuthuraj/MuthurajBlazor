...
{
    public interface ICountryService2
    {
        Task<(IEnumerable<CountryDto> countries, MetaData metaData)> GetAllAsync(CountryParameters countryParameters, bool trackChanges);
